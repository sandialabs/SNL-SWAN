...
% Modified by Kelley Ruehl, SNL (4-30-2013)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
loc_swan = [init_path 'Visual Studio Compiles\SNL_SWAN_v4SEI\SNL_SWAN_v4SEI\Debug\']; % location of source code and newly compiled SWAN.exe
loc_output = [init_path 'SNL-SWAN Test Cases\SNL_SWAN_v4 - 4-29-2013\diffrac\']; %location to save SWAN Input/Output files
...
copyfile('snl_swan_v4sei.exe',loc_output)
